 ...
 * CPU clock must be at least 1Mhz as we setup a 1uS HW timer to keep track of
 * uptime
 */
 ...
 * We assume that this will never overflow in the lifetime of a program:
 * 18,446,744,073,709,551,615 uS = 584,942 years
 */
