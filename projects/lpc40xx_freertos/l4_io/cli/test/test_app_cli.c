...
//  *
//  *****************************************************************************/
// static void app_cli_output_function(app_cli__argument_t argument, const char
// *string) {
//   UNUSED(argument);
...
//                                                output_print_string) {
//   sl_string_t output_string = user_input_minus_command_name; // re-use the
//   string
...
// static app_cli_status_e app_cli__fail_handler(app_cli__argument_t argument,
// sl_string_t user_input_minus_command_name,
//                                               app_cli__print_string_function
//                                               output_print_string) {
//   UNUSED(argument);
...
// static app_cli_status_e app_cli__sibros_handler(app_cli__argument_t argument,
// sl_string_t user_input_minus_command_name,
//                                                 app_cli__print_string_function
//                                                 output_print_string) {
//   UNUSED(argument);
//   sl_string__insert_at(user_input_minus_command_name, 0, "string argument
//   was: "); output_print_string(argument, user_input_minus_command_name);
...
//   cli_output_string = sl_string__initialize(cli_output_string_memory,
//   sizeof(cli_output_string_memory)); cli_input_string =
//   sl_string__initialize(cli_input_string_memory,
//   sizeof(cli_input_string_memory));

//   static app_cli__command_s hello_command = {.command_name = "hello",
//                                              .help_message_for_command =
//                                              "responds back with 'hello
//                                              world'", .app_cli_handler =
//                                              app_cli__hello_handler};
//   static app_cli__command_s fail_command = {.command_name = "fail",
//                                             .help_message_for_command =
//                                             "always returns failure",
//                                             .app_cli_handler =
//                                             app_cli__fail_handler};
//   static app_cli__command_s sibros_command = {.command_name = "sibros",
//                                               .help_message_for_command =
//                                               "outputs command string
//                                               arguments", .app_cli_handler =
//                                               app_cli__sibros_handler};
...
//   TEST_ASSERT_TRUE(NULL != strstr(cli_output_string, "outputs command string
//   arguments")); TEST_ASSERT_TRUE(NULL != strstr(cli_output_string, "always
//   returns failure")); TEST_ASSERT_TRUE(NULL != strstr(cli_output_string,
//   "responds back with 'hello world'"));
// }

// void test_unmatched_command(void) {
//   static const char *expected_unmatched_command_output = "Unable to match any
//   registered CLI command for: unmatched\r\n"
//                                                          "List of commands:
//                                                          \r\n" " sibros:
//                                                          outputs command
//                                                          string
...
//   app_cli__process_input(&cli, no_arg, input_string("unmatched"));
//   TEST_ASSERT_EQUAL_STRING(expected_unmatched_command_output,
//   cli_output_string);
// }
...
//       "Command failed: fail\r\nCommand help message: always returns
//       failure\r\n\x03";
...
//   TEST_ASSERT_EQUAL_STRING("string argument was: 123\x03",
//   cli_output_string);
// }
...
//   static const char *expected_unmatched_command_output = "Unable to match any
//   registered CLI command for: sibro 123\r\n"
//                                                          "List of commands:
//                                                          \r\n" " sibros:
//                                                          outputs command
//                                                          string
